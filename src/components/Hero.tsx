...
export default function Hero() {
  return (
    <section className="h-screen flex flex-col justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-8 relative z-10 flex flex-col justify-center h-full pt-16">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16">
          {/* Left content column */}
          <div className="flex-1 max-w-2xl lg:max-w-none lg:w-1/2">
            ...
            <AnimatedElement delay={2} animation="fade-in-up">
              <div className="flex flex-col sm:flex-row gap-4 mb-10">
                <a
                  href="#download"
                  className="amber-button px-8 py-3.5 rounded-md text-center text-base font-medium flex items-center justify-center gap-2 hover:scale-105 transition-transform"
                >
                  Install Extension
                ...
                <a
                  href="#features"
                  className="glass-button px-8 py-3.5 rounded-md text-center text-base font-medium flex items-center justify-center gap-2 hover:scale-105 transition-transform"
                >
                  See How It Works
                  <ArrowDown size={18} />
                </a>
            ...
            <AnimatedElement delay={2.5} animation="fade-in">
              <div className="flex items-center gap-4 text-sm text-gray-400">
                <div className="flex">
                  ...
                  <img src="https://upload.wikimedia.org/wikipedia/commons/a/a0/Firefox_logo%2C_2019.svg" alt="Firefox" className="h-5 w-5 -ml-1" />
                  <img src="https://images.icon-icons.com/2552/PNG/512/edge_browser_logo_icon_152998.png" alt="Edge" className="h-5 w-5 -ml-1" />
                </div>
          ...
          <AnimatedElement 
            className="flex-1 lg:w-1/2 flex justify-center items-center mt-12 lg:mt-0" 
            delay={1.8} 
